...
angular.module('customAMChartsDirective', []).directive('camChart', ['$q', function ($q) {
  return {
    restrict: 'E',
    replace: true,
    scope: {
    ...
    link: function ($scope, $el) {
      ...
      //$scope.options = JSON.parse("{titles: [{size: 15, text: " + $scope.maintitle + "}], data: [{title: " + $scope.firsttitle + ", yield: " + $scope.firstvalue + ", }, {title: " + $scope.secondtitle +", yield: " + $scope.secondvalue +", }], type: 'serial', theme: 'light', graphs: [{type: 'column', title: 'תשואה', valueField: 'yield', fillAlphas: 1 }], }");
